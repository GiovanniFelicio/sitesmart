...
INSERT INTO `knex_migrations` VALUES (1,'20200520190251_sbr_users.js',1,'2020-05-22 10:57:16'),(2,'20200520191616_sbr_groups.js',1,'2020-05-22 10:57:16'),(3,'20200520191750_sbr_groups_sub.js',1,'2020-05-22 10:57:16'),(4,'20200520192352_sbr_qnr.js',1,'2020-05-22 10:57:16'),(5,'20200520192416_sbr_groups_sub_qn_models.js',1,'2020-05-22 10:57:16'),(6,'20200520192441_sbr_groups_sub_qn.js',1,'2020-05-22 10:57:16'),(7,'20200520193123_sbr_groups_sub_qn_qnr.js',1,'2020-05-22 10:57:16'),(8,'20200522231200_sbr_groups_sub_qn_answers.js',2,'2020-05-23 02:16:41');
...
CREATE TABLE `sbr_groups_sub_qn` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id_sbr_groups_sub` int(11) NOT NULL,
...
CREATE TABLE `sbr_groups_sub_qn_answers` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id_sbr_groups_sub_qn` int(11) NOT NULL,
  `id_sbr_qnr` int(11) NOT NULL,
  `id_sbr_groups_sub_qn_models` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
/*!40000 ALTER TABLE `sbr_groups_sub_qn_answers` DISABLE KEYS */;
/*!40000 ALTER TABLE `sbr_groups_sub_qn_answers` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-05-22 23:57:24
